...
export const inputConfig: IInputType = {
  footer: {
    ...
    type: "tel",
    styles:
      "pl-[33px] py-[14px] pr-[47px] placeholder-additional2 bg-main1 text-additional2",
    button: (
  ...
  selection: {
    type: "text",
    styles:
      "max-w-[160px] pl-[33px] py-[14px] pr-[47px] placeholder-additional2 text-additional2 bg-main1",
  },
  productSearch: {
    
    type: "text",
    styles:
      "w-full px-[48px] py-[20px]  placeholder-additional2 text-additional2 bg-main1",
    button: (
